...
public class MarketServiceImpl implements MarketService {
    ...
    public String createdPerson() {
        try {
            ...
            System.out.println("SELECT COUNTRY : \n 1.RUSSIAN.  2.USA. 3.FRENCH. 4.CHINA. 5.JAPAN. 6.KYRGYZSTAN;");
            String country = new Scanner(System.in).nextLine();
            Country country1 = null;
            switch (country) {
                case "russia" -> country1 = Country.RUSSIAN;
                case "usa" -> country1 = Country.USA;
                case "french" -> country1 = Country.FRENCH;
                case "china" -> country1 = Country.CHINA;
                case "japan" -> country1 = Country.JAPAN;
                case "kyrgyzstan" -> country1 = Country.KYRGYZSTAN;
                default -> System.out.println(" YOU DID NOT CHOOSE A COUNTRY ! ");
            }
            List<Grocerys> basket = new ArrayList<>();
            personList.add(new Person(firstName, lastName, date, bankAccount, country1, basket));
